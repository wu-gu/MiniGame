...
public class CoachWater : PostEffectBase
{
    ...
    public void OneWaterWave()
    {
        this.enabled = true;
        startPos = new Vector4(0.5f, 0.5f, 0, 0);
        waveStartTime = Time.time;
    }
    public void TowWaterWave()
    {
        startPos = new Vector4(0.8f, 0.4f, 0, 0);
        waveStartTime = Time.time;
    }
    public void ThreeWaterWave()
    {

        startPos = new Vector4(0.6f, 0.4f, 0, 0);
        waveStartTime = Time.time;
    }
}
